                        ...
                        <div class="bet-form">
                                    ...
                                    <div class="form-row">
                                        <div class="form-field">
                                            ...
                                            <div class="buttons-group no-top-radius">
                                                <button type="button" class="btn btn-action" data-action="plus" data-value="0.50">R$ 0,50</button>
                                                <button type="button" class="btn btn-action" data-action="plus" data-value="1.00">R$ 1,00</button>
                            ...
                            <div class="command-type btnToggle">
								<button class="btn-bet bet-red" data-team="red">
									<div class="bet-chance">
										<div class="chance-text">
											<span id="red_persent">{{$chances[0]}}%</span><br>Roxo
								...
								<button class="btn-bet bet-blue" data-team="blue">
									<div class="bet-chance">
										<div class="chance-text">
											<span id="blue_persent">{{$chances[1]}}%</span><br>Azul
                            ...
                            <button type="button" class="btn btn-green btn-play"><span>Fazer uma aposta</span></button>
                        </div>
			...
			<div class="game-component">
				<div class="game_Wheel">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Aposta Mínima: <span id="minBet">{{$settings->battle_min_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Aposta Máxima: <span id="maxBet">{{$settings->battle_max_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
						<div class="progress-item right">
							<div class="title">Partida #<span id="gameId">{{$game->id}}</span></div>
						</div>
					</div>
								...
								<g class="chart" transform="translate(200, 200)">
									<g class="timer" transform="translate(0,0)">
										<g class="bets" id="circle" style="transform: rotate(0deg);">
											...
											<path id="red" fill="#5e0ea1" stroke-width="5px" d="M1.1021821192326179e-14,200A200,200,0,1,1,-3.3065463576978534e-14,-200L-2.847303808017596e-14,-180A180,180,0,1,0,9.491012693391987e-15,180Z" transform="rotate(0)" style="opacity: 1;"></path>
										</g>
									</g>
								</g>
								<polygon points="200,10 220,40 180,40" style="fill: #ffffff;stroke: #272d39;stroke-width: 5px;"></polygon>
							</svg>
							<div class="time">
								<div class="block">
									<div class="title">Apostas</div>
									<div class="value bank" id="value" style="color: #7b8893"><span id="red_sum" style="color: #5e0ea1;">{{$bank[0]}}</span>/<span id="blue_sum" style="color: #4986f5;">{{$bank[1]}}</span></div>
									<div class="line"></div>
				...
				<div class="game-sign">
					<div class="game-sign-wrap">
						...
						Você precisa estar conectado para jogar 
					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td><span class="bet-type bet_{{$b->color}}">{{$b->color == 'red' ? 'Roxo' : 'Azul'}}</span></td>
							</tr>
							@endforeach
						</tbody>
					</table>
